...
class AttendanceApproveRepository extends HrisRepository {
    ...
    public function getAllRequest($id): Traversable {
        ...
        $select->columns([
            ...
            new Expression("INITCAP(TO_CHAR(AR.ATTENDANCE_END_DT, 'DD-MON-YYYY')) AS ATTENDANCE_END_DT_AD"),
            new Expression("BS_DATE(TO_CHAR(AR.ATTENDANCE_END_DT, 'DD-MON-YYYY')) AS ATTENDANCE_END_DT_BS"),
