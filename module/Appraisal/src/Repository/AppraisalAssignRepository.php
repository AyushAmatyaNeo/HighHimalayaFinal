...
";
    ...
    public function getEmployeeAppraisalDetail($employeeId, $appraisalId) {
        ...
        $select->from(["A" => Setup::TABLE_NAME])
                ...
                ->join(['MTH' => Months::TABLE_NAME],"MTH.FISCAL_YEAR_ID = MTH.FISCAL_YEAR_ID AND (MTH.FISCAL_YEAR_MONTH_NO = CASE WHEN MTH.FISCAL_YEAR_MONTH_NO IS NOT NULL THEN MTH.FISCAL_YEAR_MONTH_NO END OR 1=1)",["FROM_DATE"=>new Expression("INITCAP(TO_CHAR(MTH.FROM_DATE,'DD-MON-YYYY'))")]);
