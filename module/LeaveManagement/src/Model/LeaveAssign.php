...
class LeaveAssign extends Model
{
    ...
    const PREVIOUS_YEAR_BAL_HR="PREVIOUS_YEAR_BAL_HR";
    const TOTAL_HOURS="TOTAL_HOURS";
    const BALANCE_HOUR="BALANCE_HOUR";
    ...
    public $mappings=[
        ...
        'previousYearBalance'=>self::PREVIOUS_YEAR_BAL_HR,
        'totalDays'=>self::TOTAL_HOURS,
        'balance'=>self::BALANCE_HOUR,
