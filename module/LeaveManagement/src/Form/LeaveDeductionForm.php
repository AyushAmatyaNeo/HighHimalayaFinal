...
class LeaveDeductionForm {
    ...
    /**
     * @Annotation\Type("Zend\Form\Element\Text")
     * @Annotation\Options({"label":"Available Hours"})
     * @Annotation\Required(true)
     * @Annotation\Attributes({ "id":"availableHours", "class":"form-control","readonly":"true"})
     */
    public $availableHours;

    /**
     * @Annotation\Type("Zend\Form\Element\Number")
     * @Annotation\Options({"label":"No of Hours"})
     * @Annotation\Required(true)
     * @Annotation\Attributes({ "id":"noOfHours", "class":"form-control", "min":"0","step":"0.5"})
     */
    public $noOfHours;
