    ...
    public function processVariable($variable) {
      ...
      /*
			...
			case PayrollGenerator::VARIABLES[35]:
                $processedValue = $this->payrollRepo->getOverTimeAddition($this->employeeId,$this->monthId);
                break; 		
            ...
            case PayrollGenerator::VARIABLES[37]:
                $processedValue = $this->payrollRepo->getNormalEligible($this->employeeId,$this->monthId);
                break; 			
