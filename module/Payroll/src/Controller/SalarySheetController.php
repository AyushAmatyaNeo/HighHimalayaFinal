...
class SalarySheetController extends HrisController
{
    ...
    public function payslipAction()
    {
        ...
        $companyDetails['COMPANY_NAME'] = $this->storageData['employee_detail']['COMPANY_NAME'];
        $companyDetails['COMPANY_LOGO'] = $this->storageData['employee_detail']['COMPANY_FILE_PATH'];
        $companyDetails['COMPANY_ADDRESS'] = $this->storageData['employee_detail']['COMPANY_ADDRESS'];
		
        return ['employeeId' => $this->employeeId, 'salaryType' => json_encode($salaryType), 'companyDetails' => $companyDetails];
    }
