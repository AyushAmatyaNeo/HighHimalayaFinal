...
use Payroll\Repository\NewVoucherImpactMapRepo;
use Zend\Authentication\Storage\StorageInterface;
use Zend\Db\Adapter\AdapterInterface;
use Zend\View\Model\JsonModel;
use Payroll\Model\AccCodeMap;

class NewEmployeeMap extends HrisController
{
    ...
    public function __construct(AdapterInterface $adapter, StorageInterface $storage)
    {
        ...
        $this->repository = new NewVoucherImpactMapRepo($adapter);
    }
    ...
    public function indexAction()
    {
        ...
        // echo('<pre>');print_r($accountListCompanyWise);die;
        return Helper::addFlashMessagesToArray($this, [
            ...
            'functionalType' => EntityHelper::getTableKVListWithSortOption($this->adapter, "HRIS_FUNCTIONAL_TYPES", "FUNCTIONAL_TYPE_ID", ["FUNCTIONAL_TYPE_EDESC"], ["STATUS = 'E'"], "FUNCTIONAL_TYPE_EDESC", "ASC", "-", false, true),
    ...
    public function insertIntoAccCodeMapAction()
    {
        ...
        if ($request->isPost()) {
            try {
                ...
                $accCodeMapData->functionalType = $data['functionalType'];
                $accCodeMapData->showSubDetail = $data['showSubDetail'];
                $this->repository->add($accCodeMapData);
                // echo('<pre>');print_r($accCodeMapData);die;
