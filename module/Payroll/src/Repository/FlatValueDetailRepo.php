...
// $logs = new Logs();
// $logs->module = 'Flat Value Detail';
// $logs->operation = 'I';
// $logs->createdBy = $data['employeeId'];
// $logs->createdDesc = 'Employee id - ' . $data['employeeId'].' and Changes Value is: '.$data['flatValue'];
// $logs->tableDesc = 'hris_flat_value_detail';
