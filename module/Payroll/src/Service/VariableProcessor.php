    ...
    public function processVariable($variable)
    {
        ...
        switch ($variable) {
            ...
            case PayrollGenerator::VARIABLES[46]:
                $processedValue = $this->payrollRepo->getTotalWorkedHours($this->employeeId, $this->monthId);
                break;


            case PayrollGenerator::VARIABLES[45]:
                $processedValue = $this->payrollRepo->getDashainMonth($this->employeeId);
                break;

            case PayrollGenerator::VARIABLES[47]:
                $processedValue = $this->payrollRepo->getLeaveHours($this->employeeId, $this->monthId);
                break;

            case PayrollGenerator::VARIABLES[48]:
                    $processedValue = $this->payrollRepo->getNormalOt($this->employeeId, $this->monthId);
                    break;
