...
use Payroll\Controller\PayrollCtcController;
...
return [
    'router' => [
        'routes' => [
            ...
            'payroll-ctc' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/payroll/payroll-ctc[/:action[/:id]]',
                    'defaults' => [
                        'controller' => Controller\PayrollCtcController::class,
                        'action' => 'index'
                    ]
                ]
            ]
    ...
    'controllers' => [
        'factories' => [
            ...
            PayrollCtcController::class => ControllerFactory::class,
        ],
    ],
    'view_manager' => [
        'template_path_stack' => [
