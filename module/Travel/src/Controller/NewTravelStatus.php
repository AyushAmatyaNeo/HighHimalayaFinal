...
use Travel\Repository\NewTravelStatusRepository;
...
class NewTravelStatus extends HrisController
{
    ...
    public function __construct(AdapterInterface $adapter, StorageInterface $storage)
    {
        ...
        $this->travelStatusRepository = new NewTravelStatusRepository($adapter);
    ...
    public function expenseDetailAction()
    {
        ...
        // echo '<pre>';print_r($totalAmountInWords );die;

        $balance = $detail['REQUESTED_AMOUNT'];
