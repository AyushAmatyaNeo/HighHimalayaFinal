...
class Profile extends HrisController
{
    ...
    public function indexAction()
    {
        ...
        $perZoneDtl = $this->repository->getZoneDtl($employeeData['ADDR_PERM_ZONE_ID']);
        ...
        $tempZoneDtl = $this->repository->getZoneDtl($employeeData['ADDR_TEMP_ZONE_ID']);
    ...
    public function editAction()
    {
        ...
        return Helper::addFlashMessagesToArray($this, [
            ...
            'letterLists' => $this->repository->getLetterByEmpId($id),
    ...
    {
        $variables = $this->variables->getVariables($this->employeeId);
    ...
    public function viewDocumentAction()
    {
        ...
        foreach ($fetchData['DESCRIPTIONS'] as $description) {
            $processedDescriptions[] = $this->replacePlaceholders($description);
        }
