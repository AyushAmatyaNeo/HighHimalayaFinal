...
use Setup\Controller\PerformanceSetupController;
...
use Setup\Controller\PerformanceController;
...
use Setup\Controller\EmployeeSetupController;
...
use Setup\Controller\LetterSetupController;
use Setup\Controller\VacancyController;
...
return [
    'router' => [
        'routes' => [
            ...
            'performanceSetup' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/setup/performanceSetup[/:action[/:id]]',
                    'defaults' => [
                        'controller' => PerformanceSetupController::class,
                        'action' => 'index'
                    ]
                ]
            ],
            'performance' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/setup/performance[/:action[/:id]]',
                    'defaults' => [
            ...
            'employeeSetup' => [
                'type' => Segment::class,
                'options' => [
                    'route' => '/setup/employeeSetup[/:action[/:id]]',
                    'defaults' => [
                        'controller' => EmployeeSetupController::class,
                        'action' => 'index'
                    ]
                ]
            ],
            ...
            'letterSetup' => [
                'type' => segment::class,
                'options' => [
                    'route' => '/setup/letterSetup[/:action[/:id]]',
                    'constants' => [
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ],
    ...
    'navigation' => [
        ...
        'performance' => [
            [
                'label' => 'Performance Percentage Setup',
                'route' => 'performance',
            ],
            [
                'label' => 'Performance Percentage Setup',
    ...
    'controllers' => [
        'factories' => [
            ...
            PerformanceController::class => ControllerFactory::class,
        ],
    ],
    'view_manager' => [
        'template_path_stack' => [
