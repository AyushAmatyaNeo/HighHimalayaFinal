...
class EmployeeController extends HrisController
{
    ...
    public function initializeMultipleForm()
    {
        ...
        if (!$this->formThree) {
            ...
            $pfBankAcc = $this->formThree->get('pfBankAcc');
            $gratuityBankAcc = $this->formThree->get('gratuityBankAcc');
            $ssfBankAcc = $this->formThree->get('ssfBankAcc');
            ...
            $pfBankAcc->setValueOptions($bankNameList);
            $gratuityBankAcc->setValueOptions($bankNameList);
            $ssfBankAcc->setValueOptions($bankNameList);
        }
        if (!$this->formFour) {
    ...
    public function editAction()
    {
        ...
        if ($id != 0) {
            ...
            $empCode = ((int) Helper::getMaxId($this->adapter, "HRIS_EMPLOYEES", "EMPLOYEE_ID")) + 1;
            ...
            switch ($tab) {
                ...
                case 3:
                    ...
                    if ($this->formThree->isValid()) {
                        ...
                        $licenseTypeJson = json_encode($formThreeModel->idDrivingLicenseType);
                        $formThreeModel->idDrivingLicenseType = $licenseTypeJson;
                ...
                case 4:
                    ...
                    if ($this->formFour->isValid()) {
                        ...
                        if ($employeeData['JOIN_DATE'] != $formFourModel->joinDate) {
                            ...
                            $sql = "BEGIN HRIS_EMPLOYEE_HOLIDAY_ASSIGN(:id); END;";
                            $boundedParams = ['id' => $id];
        ...
        return Helper::addFlashMessagesToArray($this, [
            ...
            'CitizenshipIssuePlaceId' => $employeeData['ID_CITIZENSHIP_ISSUE_PLACE'],
    ...
    public function districtAction()
    {
        ...
        $districtKV = HrisQuery::singleton()
            ...
            ->setWhere(["PROVINCE_ID" => $provinceId])
    ...
    public function municipalityAction()
    {
        ...
        $post = $request->getPost();
        $districtId = $post->id;
        $municipalityKV = HrisQuery::singleton()
            ->setAdapter($this->adapter)
            ->setTableName("HRIS_MUNICIPALITIES")
            ...
            ->setIncludeEmptyRow(true)
            ->result();
        return new JsonModel($municipalityKV);
    }
