...
class HeadNotification
{
    ...
    private static function leaveApplied(LeaveApply $leaveApply, AdapterInterface $adapter, Url $url, $type)
    {
        ...
        // echo'<pre>';print_r($leaveName);die;
        ...
        $leaveReqNotiMod->noOfDays = $leaveApply->noOfDays;
		 if(!$leaveReqNotiMod->toId){
            switch ($type) {
            case self::RECOMMENDER:
                $roleDesc = "Recommender";
                break;
            case self::APPROVER:
                $roleDesc = "Approver";
            ...
            throw new Exception($roleDesc . " Employee not found to send notification");
        }
        // dd($leaveReqNotiMod);
        ...
        $notificationDesc = "Leave Request of $leaveReqNotiMod->fromName";
    ...
    private static function travelApplied(TravelRequest $request, AdapterInterface $adapter, Url $url, $type)
    {
        ...
        //self::initFullModel(new NewTravelRequestRepository($adapter), $request, $request->travelId);
    ...
    {  
        ...
        $toEmail = $toEmployee['EMAIL_OFFICIAL'] ? $toEmployee['EMAIL_OFFICIAL'] : $toEmployee['EMAIL_PERSONAL'];
