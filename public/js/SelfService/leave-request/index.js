(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        app.initializeKendoGrid($table, [
            ...
            { field: "TOTAL_HOURS", title: "Duration" },
        ...
        app.searchTable('leaveRequestTable', ['LEAVE_ENAME', 'REQUESTED_DT_AD', 'REQUESTED_DT_BS', 'FROM_DATE_AD', 'FROM_DATE_BS', 'TO_DATE_AD', 'TO_DATE_BS', 'TOTAL_HOURS', 'STATUS_DETAIL']);
        var exportMap = {
            'LEAVE_ENAME': 'Leave',
