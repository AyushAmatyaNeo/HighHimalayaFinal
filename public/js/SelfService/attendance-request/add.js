...
//         var $attendanceDt = $("#attendanceDt");
//         var $attendanceEndDt = $("#attendanceEndDt");
...
//         if (!($attendanceEndDt.is('[readonly]'))) {
//             app.datePickerWithNepali("attendanceEndDt", "nepaliDate2");
//             app.getServerDate().then(function(response) {
//                 $attendanceEndDt.datepicker('setEndDate', app.getSystemDate(response.data.serverDate));
//             }, function(error) {
//                 console.log("error=>getServerDate", error);
//             });
//         } else {
