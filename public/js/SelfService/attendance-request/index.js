    ...
    $(document).ready(function() {
        ...
        var columns = [{
            ...
            },
            {
                ...
                columns: [{
                        field: "ATTENDANCE_END_DT_AD",
                        title: "AD",
                    },
                    {
                        field: "ATTENDANCE_END_DT_BS",
                        title: "BS",
                    }
                ]
            },
        ...
        app.searchTable('attendanceRequestTable', ['REQUESTED_DT_AD', 'REQUESTED_DT_BS', 'ATTENDANCE_DT_AD', 'ATTENDANCE_DT_BS', 'ATTENDANCE_END_DT_AD', 'ATTENDANCE_END_DT_BS', 'IN_TIME', 'OUT_TIME', 'A_STATUS']);

        var exportMap = {
            'REQUESTED_DT_AD': 'Request Date(AD)',
            'REQUESTED_DT_BS': 'Request Date(BS)',
            'ATTENDANCE_DT_AD': 'Attendance Start Date(AD)',
            'ATTENDANCE_DT_BS': 'Attendance Start Date(BS)',
            'ATTENDANCE_END_DT_AD': 'Attendance End Date(AD)',
            'ATTENDANCE_END_DT_BS': 'Attendance End Date(BS)',
            'IN_TIME': 'In Time',
            'OUT_TIME': 'Out Time',
