(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        if (formattedDate) {
            ...
            if (formattedDate && employeeId) {
                $('#startDate').val(formattedDate);
                $('#endDate').val(formattedDate);
                sessionStorage.removeItem('formattedDate');
                checkForErrors(formattedDate, formattedDate, employeeId);
            } else {
        ...
        var calculateavailableHours= function (startDateStr, endDateStr, halfDay, employeeId, leaveId) {
        ...
        app.startEndDatePickerWithNepali('nepaliStartDate1', 'startDate', 'nepaliEndDate1', 'endDate', function (startDate, endDate, startDateStr, endDateStr) {
            ...
            calculateavailableHours(startDateStr, endDateStr, halfDayValue, employeeId, leaveId);
        ...
        myDropzone = new Dropzone("div#dropZoneContainer", {
            ...
            maxFiles: 1,
            acceptedFiles: ".jpg,.jpeg,.png,.pdf,.docx",  // Only allow JPG and PNG files
            addRemoveLinks: true,
            init: function () {
