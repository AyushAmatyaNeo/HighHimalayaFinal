(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var addrPermProvinceId = $('#addrPermProvinceId');
        ...
        var addrTempProvinceId = $('#addrTempProvinceId');
        var addrTempDistrictId = $('#addrTempDistrictId');
        var addrTempVdcMunicipalityId = $('#addrTempVdcMunicipalityId');
        ...
        var onChangePermProvince = function (provinceId) {
            if (provinceId == null) {
                app.populateSelectElement(addrPermDistrictId, []);
                onChangePermDistrict(null);
                return;
            }
            app.pullDataById(document.urlDistrict, { id: provinceId }).then(function (data) {
                app.populateSelectElement(addrPermDistrictId, data, address['addrPermDistrictId']);
                onChangePermDistrict(addrPermDistrictId.val());
            }, function (error) {
                console.log("url=>" + document.urlDistrict, error);
        ...
        var onChangeTempProvince = function (provinceId) {
            if (provinceId == null) {
        ...
        var onChangePermDistrict = function (districtId) {
            if (districtId == null) {
                app.populateSelectElement(addrPermVdcMunicipalityId, []);
                onChangePermVdcMunicipality(null);
                return;
            }
            app.pullDataById(document.urlMunicipality, { id: districtId }).then(function (data) {
                app.populateSelectElement(addrPermVdcMunicipalityId, data, address['addrPermVdcMunicipalityId']);
                onChangePermVdcMunicipality(addrPermVdcMunicipalityId.val());
            }, function (error) {
        ...
        var onChangeTempDistrict = function (districtId) {
            if (districtId == null) {
                app.populateSelectElement(addrTempVdcMunicipalityId, []);
                onChangeTempVdcMunicipality(null);
                return;
            }
            app.pullDataById(document.urlMunicipality, { id: districtId }).then(function (data) {
                app.populateSelectElement(addrTempVdcMunicipalityId, data, address['addrTempVdcMunicipalityId']);
                onChangeTempVdcMunicipality(addrTempVdcMunicipalityId.val());
            }, function (error) {
                console.log("url=>" + document.urlMunicipality, error);
            });
        };
        ...
        addrPermProvinceId.on('change', function () {
            var $this = $(this);
            onChangePermProvince($this.val());
        });
        ...
        addrTempProvinceId.on('change', function () {
            var $this = $(this);
            onChangeTempProvince($this.val());
        });
        ...
        onChangePermProvince(addrPermProvinceId.val());
        onChangeTempProvince(addrTempProvinceId.val())
