(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var repTemplate = `
<div style="padding:0%;"font-size:12px"><center><h1><b>{{COMPANY_NAME}}</b></h1>
<h5><b>{{ADDRESS}}</b></h5></center>
<br><br><div style="width:82%;text-align:right;"font-size:12px">Date: {{TODAY_DATE}}</div>
<br><br>To,<br>
The Branch Manager,<br>
<b>{{BANK_NAME}}</b>.<br><br>

<p style="margin-left:30%";"font-size:12px";>Subject: <u><b>Request for amount transfer</b></u></p>
<br><br>
